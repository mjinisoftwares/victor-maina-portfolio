    ...
    return (
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12 mt-6 pb-20">
        ...
        <div className="py-24 text-center space-y-4">
          <LayoutTemplate className="mx-auto size-12 text-muted-foreground/50" />
          ...
          <Link href="/templates">
            <Button variant="outline" className="rounded-xl">
              <ArrowLeft className="size-4 mr-1.5" /> Back to Templates
            </Button>
          </Link>
        </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {template.featured && (
              <Badge variant="secondary" className="text-xs flex items-center gap-1">
                <Sparkles className="size-3 text-primary" /> Featured Kit
              </Badge>
            )}
          </div>
        ...
        <footer className="mt-16 border-t border-border pt-12 space-y-12">
                ...
                <div className="pt-2">
                  <Link href="/contact">
                    <Button size="sm" className="rounded-xl text-xs font-semibold">
                      Request Custom Implementation <ArrowRight className="size-3.5 ml-1" />
                    </Button>
                  </Link>
                </div>
              </div>
          ...
          {relatedTemplates.length > 0 && (
            <div className="space-y-6">
              <h3 className="text-xl font-bold tracking-tight">More Starter Kits & Templates</h3>
